...
namespace proyectoFinal1.Controllers
{
    public class facturasController : Controller
    {
        ...
        {
            var factura = db.factura.Include(f => f.producto1);
        ...
        public ActionResult Create([Bind(Include = "id,cliente,nit,producto,cantidad")] factura factura)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,cliente,nit,producto,cantidad")] factura factura)
        {
            if (ModelState.IsValid)
            {
